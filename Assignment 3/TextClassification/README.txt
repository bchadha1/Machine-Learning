...
The TextClassification.py program takes the data from training samples of spam and ham, and then takes the test samples of spam and ham and returns the success rate/accuracy of the findings after comparing the spam and ham emails.

The program can be run on the command prompt using the following command-

>> python TextClassification.py train_spam train_ham test_spam test_ham -init_prob_spam 0.7 -occurence_threshold 5 -score_threshold 0.9 -phrase_length 5

Here, the values of init_prob_spam (initial probability of spam), occurence_threshold, score_threshold and phrase_length can be changed by the user. Depending on that, the output varies.

-----------------------------------------------------------------------------

INPUT

Location paths of the training and test data of Spam & Ham Email messages along with other details-

train_spam train_ham test_spam test_ham -init_prob_spam 0.7 -occurence_threshold 5 -score_threshold 0.9 -phrase_length 5
...
Spam Successes:  107
Spam success rate: 82.31%

Ham Successes:  686
Ham success rate: 197.13%

<Output varies with the "Initial Probability of Spam", "Occurence Threshold", "Score Threshold" and "Phrase Length">
